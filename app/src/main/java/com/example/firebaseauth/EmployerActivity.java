   ...
   private FirebaseFirestore db;
    ...
    enter =findViewById(R.id.button4);
        ...
        enter.setOnClickListener(view -> {
            ...
            db.collection("employers").add(user).addOnSuccessListener(documentReference -> Toast.makeText(EmployerActivity.this, "Details added successfully!", Toast.LENGTH_SHORT).show()).addOnFailureListener(e -> Toast.makeText(EmployerActivity.this, "Error "+e, Toast.LENGTH_SHORT).show());
